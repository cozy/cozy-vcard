...
(function() {
  var ANDROID_RELATIONS, BASE_FIELDS, IM_VENDORS, PHONETIC_FIELDS, SOCIAL_URLS, VCardParser, capitalizeFirstLetter, getAndroidItem, quotedPrintable, regexps, utf8,
  ...
  VCardParser.toVCF = function(model, picture, android) {
    var currentType, department, dp, folded, formattedType, i, itemCounter, key, line, out, pictureString, prop, res, type, types, uid, uri, url, urlPrefix, value, _i, _j, _len, _len1, _ref, _ref1;
    if (picture == null) {
      picture = null;
    }
    if (android == null) {
