...
(function() {
  var ANDROID_RELATIONS, BASE_FIELDS, IM_VENDORS, IOS_IM_VENDORS, IOS_SERVICE_LABELS, IOS_SERVICE_TYPES, PHONETIC_FIELDS, SOCIAL_URLS, VCardParser, capitalizeFirstLetter, getAndroidItem, isValidDate, quotedPrintable, regexps, utf8,
  ...
  VCardParser.toVCF = function(model, picture, mode) {
    var currentType, department, dp, folded, formattedType, i, itemCounter, key, line, out, pictureString, prop, res, serviceType, type, types, uid, uri, url, urlPrefix, value, _i, _j, _len, _len1, _ref, _ref1;
    if (picture == null) {
      picture = null;
    }
    if (mode == null) {
    ...
    for (i in _ref) {
      ...
      type = ((_ref1 = dp.type) != null ? _ref1.toUpperCase() : void 0) || null;
      value = dp.value;
      if (Array.isArray(value)) {
