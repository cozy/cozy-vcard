...
(function() {
  var ANDROID_RELATIONS, BASE_FIELDS, IM_VENDORS, PHONETIC_FIELDS, VCardParser, capitalizeFirstLetter, getAndroidItem, quotedPrintable, regexps, utf8,
  ...
  VCardParser = (function() {
    ...
    VCardParser.prototype.handleExtendedLine = function(line) {
      var all, elements, key, type, user, value, _ref;
  ...
  VCardParser.toVCF = function(model, picture, android) {
    var currentType, department, dp, folded, formattedType, i, itemCounter, key, line, out, pictureString, prop, type, types, uid, uri, value, _i, _j, _len, _len1, _ref, _ref1;
    if (picture == null) {
      picture = null;
    }
    if (android == null) {
